...
public class DashboardController {
	...
	public ResponseEntity<?> statisticsTicketPriceByMovie(@RequestParam("branchName") String branchName) {
	...
	public ResponseEntity<?> statisticsTicketPriceByMovie2(@RequestParam("movieName") String movieName,@RequestParam("year") int year,@RequestParam("branchName") String branchName) {
